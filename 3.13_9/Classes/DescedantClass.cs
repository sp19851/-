...
namespace _3._13_9.Classes
{
    ...
    class DescedantClass : BaseClass
    {
        ...
        {
            base.i = a; // здесь обнаруживается скрытый член из класса BaseClass
            i = b; // член i из класса DescedantClass
        }

        public void Show()
        {
            // Здесь выводится член i из класса BaseClass.
            Console.WriteLine("Член i в базовом классе: " + base.i);
            // А здесь выводится член i из класса DescedantClass.
            Console.WriteLine("Член i в производном классе: " + i);

            //Несмотря на то что переменная экземпляра i в производном классе скрывает переменную i из базового класса BaseClass, ключевое слово base разрешает доступ к
